...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      includes: "שילוב של מפה בסיסית אישית לכל אחד ומפה זוגית משותפת",
    ...
    },
    {
      ...
      includes: "שילוב של מפה מורחבת אישית לכל אחד ומפה זוגית מפורטת",
  ...
  return <>
    <div className={styles.servicesContainer}>
      ...
      <div className={styles.additionalInfo}>
        <p>אפשר לבצע פגישה אונליין או פרונטלית למי שבאיזור.</p>
        <p>יש אופציה לקבוע דרכי ידנית בשליחת הודעה או השארת פרטים או ללחוץ על כפתור שמביא אותו לקביעת תור עצמאית.</p>
        <p>לאחר בחירת השירות הוא מועבר לדף של בחירת מועד הפגישה של כשעה ורבע, הוא בוחר מועד, משלם מראש סכום מלא באתר (יש גם תנאי ביטול) ולאחר מכן צריך לענות על שאלון אישי הנדרש לבניית המפה שישלח אלי. ואז אנחנו נפגשים במועד והמפה נשלחת במייל ללקוח.</p>
      </div>
    </div>
