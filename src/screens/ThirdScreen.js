                ...
                <div className={styles.bigWrapper}>
                    ...
                    <div className={styles.step} itemScope itemType="https://schema.org/Organization">
                        ...
                        <div className={styles.text}>
                            ...
                            <div className={styles.section} itemProp="description">
                                להבין את הדינמיקה בזוגיות ובמערכות יחסים אחרות דרך מפה זוגית. נגלה את ההתאמה האנרגטית, 
                                האתגרים המשותפים והדרך לתקשורת מיטבית שתחזק את הקשר שלך.
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={styles.step} itemScope itemType="https://schema.org/Course">
                        ...
                        <div className={styles.text}>
                            ...
                            <div className={styles.section} itemProp="description">
                                לשפר את הקשר שלך עם כסף ולשחרר אמונות מגבילות. ריבוע פיתגורס בנומרולוגיה 
                                חושף חסמים כלכליים מולדים ומספק תובנות לפתיחת ערוצי שפע ויציבות כלכלית.
                            </div>
                        </div>
                    </div>
